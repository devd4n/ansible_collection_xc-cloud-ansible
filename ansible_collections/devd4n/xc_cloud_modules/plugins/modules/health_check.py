...
description:
    - Health Check view defines a required parameters that can be used in CRUD,
      to create and manage Health Checks. It can be used to create Health Checks
      and HTTPS Health Checks.
version_added: "0.0.1"
options:
    metadata:
        annotations:
    ...
    spec:
        description:
            - Shape of the Health Monitor specification
              https://docs.cloud.f5.com/docs/api/healthcheck
...
class ModuleManager(object):
    ...
    def remove(self):
        uri = f"/api/config/namespaces/{self.want.metadata['namespace']}/healthchecks/{self.want.metadata['name']}"
    ...
    def create(self):
        uri = f"/api/config/namespaces/{self.want.metadata['namespace']}/healthchecks"
